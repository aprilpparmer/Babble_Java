...
/**
 * Tests if a TileRack with the tiles "HEAVYHX" contains the word "WET".
 * 
 * @author April Parmer
 * @version November 21, 2014
 *
 */
public class TileRackShouldNotContainWordWet {

	/**
	 * Creates a TileRack, adding the letters "HEAVYHX", and asserts that the word
	 * "WET" CANNOT be made from the Tiles on the rack.
	 */
	@Test
	public void testTileRackShouldNotContainWordWet() {
